...
<div class="row container">
	...
	<div class="book_menu">
		<form name = "delFORM" action = "/productDel?name={{$content->cont_name}}" method="post">
        <input type="button" value="상품 삭제" data-toggle="modal" data-target="#myModal" />
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		      	<button onClick ="pro_DEL()">네!!!</button>
